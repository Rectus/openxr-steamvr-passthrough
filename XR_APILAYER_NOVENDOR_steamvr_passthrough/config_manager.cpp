...
void ConfigManager::SetupStereoPresets()
{
	...
	m_stereoPresets[1].StereoDepthMapScale = 1;
	m_stereoPresets[1].StereoCutoutEnabled = false;
	m_stereoPresets[1].StereoCutoutFactor = 3.0f;
	m_stereoPresets[1].StereoCutoutOffset = 1.0f;
	m_stereoPresets[1].StereoCutoutFilterWidth = 1.5f;
	m_stereoPresets[1].StereoCutoutCombineFactor = 0.0f;
	m_stereoPresets[1].StereoCutoutSecondaryCameraWeight = 0.5f;

	m_stereoPresets[1].StereoBlockSize = 7;
	...
	m_stereoPresets[2].StereoDepthMapScale = 1;
	m_stereoPresets[2].StereoCutoutEnabled = false;
	m_stereoPresets[2].StereoCutoutFactor = 3.0f;
	m_stereoPresets[2].StereoCutoutOffset = 1.0f;
	m_stereoPresets[2].StereoCutoutFilterWidth = 1.5f;
	m_stereoPresets[2].StereoCutoutCombineFactor = 1.0f;
	m_stereoPresets[2].StereoCutoutSecondaryCameraWeight = 0.5f;

	m_stereoPresets[2].StereoBlockSize = 5;
	...
	m_stereoPresets[2].StereoSGBM_P1 = 40;
	m_stereoPresets[2].StereoSGBM_P2 = 64;
	...
	m_stereoPresets[3].StereoDepthMapScale = 1;
	m_stereoPresets[3].StereoCutoutEnabled = false;
	m_stereoPresets[3].StereoCutoutFactor = 3.0f;
	m_stereoPresets[3].StereoCutoutOffset = 1.0f;
	m_stereoPresets[3].StereoCutoutFilterWidth = 1.5f;
	m_stereoPresets[3].StereoCutoutCombineFactor = 0.0f;
	m_stereoPresets[3].StereoCutoutSecondaryCameraWeight = 0.5f;

	m_stereoPresets[3].StereoBlockSize = 3;
	...
	m_stereoPresets[4].StereoDisparityFilterWidth = 1;
	m_stereoPresets[4].StereoDepthMapScale = 1;
	m_stereoPresets[4].StereoCutoutEnabled = true;
	m_stereoPresets[4].StereoCutoutFactor = 3.0f;
	m_stereoPresets[4].StereoCutoutOffset = 1.0f;
	m_stereoPresets[4].StereoCutoutFilterWidth = 1.5f;
	m_stereoPresets[4].StereoCutoutCombineFactor = 1.0f;
	m_stereoPresets[4].StereoCutoutSecondaryCameraWeight = 0.5f;
	...
	m_stereoPresets[5].StereoDepthMapScale = 2;
	m_stereoPresets[5].StereoCutoutEnabled = true;
	m_stereoPresets[5].StereoCutoutFactor = 3.0f;
	m_stereoPresets[5].StereoCutoutOffset = 1.0f;
	m_stereoPresets[5].StereoCutoutFilterWidth = 1.5f;
	m_stereoPresets[5].StereoCutoutCombineFactor = 1.0f;
	m_stereoPresets[5].StereoCutoutSecondaryCameraWeight = 0.5f;
