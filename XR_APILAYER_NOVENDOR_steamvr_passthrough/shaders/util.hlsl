...
float lanczos2(in Texture2D<float> tex, float2 uvs, float2 res)
{
...
float catmull_rom_9tap(in Texture2D<float> tex, in SamplerState linearSampler, in float2 uv, in float2 texSize)
{
